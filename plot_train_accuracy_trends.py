...
# Load training accuracy across epochs
...
plt.title("Training Accuracy Trends Across Variants")
plt.xlabel("Epoch")
...
# Save plot
output_path = "/content/drive/MyDrive/ResearchforPub/WideCutDenseNet/logs/train_accuracy_trends.png"
